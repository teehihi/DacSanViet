...
class CartServiceTest {
    ...
    @Autowired
    private com.dacsanviet.repository.CategoryRepository categoryRepository;
    ...
    void testAddToCart_NewItem() {
        ...
        // When
        CartDao cart = cartService.addToCart(testUser.getId(), request);
    ...
    void testUpdateCartItem() {
        ...
        CartDao cart = cartService.updateCartItem(testUser.getId(), updateRequest);
    ...
    void testRemoveFromCart() {
        ...
        // When - Remove item
        CartDao cart = cartService.removeFromCart(testUser.getId(), testProduct.getId());
    ...
    void testGetCart_EmptyCart() {
        // When
        CartDao cart = cartService.getCart(testUser.getId());
