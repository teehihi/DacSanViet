...
public class OrderServiceTest {
    ...
    void testCreateOrder() {
        ...
        // When
        OrderDao result = orderService.createOrder(testUser.getId(), request);
    ...
    void testGetOrderById() {
        ...
        OrderDao createdOrder = orderService.createOrder(testUser.getId(), request);
        
        // When
        OrderDao result = orderService.getOrderById(createdOrder.getId());
    ...
    void testCancelOrder() {
        ...
        // When
        OrderDao result = orderService.cancelOrder(createdOrder.getId(), testUser.getId());
